...
<body id="kt_body"
    ...
    <div id="kt_header_mobile" class="header-mobile align-items-center header-mobile-fixed">
        <!--begin::Logo-->
        <a href="index.html">
            <img alt="Logo" src="<?php echo e(asset('assets/img/logo.png')); ?>" style="width: 90px;" />
        </a>
        <!--end::Logo-->
        <!--begin::Toolbar-->
            ...
            <div class="aside aside-left aside-fixed d-flex flex-column flex-row-auto" id="kt_aside">
                ...
                <div class="brand flex-column-auto">
                    ...
                    <a href="<?php echo e(url('/')); ?>" class="brand-logo">
                        <img alt="" src="<?php echo e(asset('assets/img/logo.png')); ?>" style="width: 50px;" />
                    </a>
                    <!--end::Logo-->
                ...
                <div class="aside-menu-wrapper flex-column-fluid" id="kt_aside_menu_wrapper">
                    ...
                    <div id="kt_aside_menu" class="aside-menu my-4" data-menu-vertical="1" data-menu-scroll="1"
                        ...
                        <!--begin::Menu Nav-->
                        <ul class="menu-nav">
                            <li class="menu-item <?php echo e(request()->routeIs('home') ? 'menu-item-active' : ''); ?>"
                                aria-haspopup="true">
                ...
                <div id="kt_header" class="header header-fixed">
                    <div class="container-fluid d-flex align-items-stretch justify-content-between">
                        ...
                        <div class="topbar">
                            ...
                            <div class="topbar-item" style="margin-left: 10px;">
                            ...
                            <div class="topbar-item">
                                <div class="btn btn-icon btn-icon-mobile w-auto btn-clean d-flex align-items-center btn-lg px-2"
                                    ...
                                    <span class="symbol symbol-lg-35 symbol-25 symbol-light-success">
                                        <span
                                            class="symbol-label font-size-h5 font-weight-bold"><?php echo e(substr('Admin', 0, 1)); ?></span>
                                    </span>
        ...
        <div class="offcanvas-content pr-5 mr-n5">
            ...
            <div class="d-flex align-items-center mt-5">
                <div class="symbol symbol-100 mr-5">
                    <div class="symbol-label" style="background-image:url('<?php echo e(asset('assets/img/logo3.png')); ?>')">
                    </div>
                ...
                <div class="d-flex flex-column">
                    ...
                    <div class="navi mt-2">
                        ...
                        <a href="<?php echo e(route('logout')); ?>"
                            class="btn btn-sm btn-light-primary font-weight-bolder py-2 px-5">Keluar</a>
                    </div>
                </div>
            </div>
            <!--end::Header-->
    ...
    <script src="<?php echo e(asset('assets/js/pages/crud/forms/widgets/select2.js?v=7.2.9')); ?>"></script>

    <script src="<?php echo e(asset('assets/js/pages/crud/ktdatatable/base/data-local.js')); ?>"></script>
    <!--end::Page Scripts-->
...
<?php /**PATH C:\xampp\htdocs\kurasi\resources\views/main.blade.php ENDPATH**/ ?>