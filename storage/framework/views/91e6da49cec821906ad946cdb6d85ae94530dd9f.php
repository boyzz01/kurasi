                    ...
                    <table class="table table-bordered table-checkable" id="kt_datatable2">
                        ...
                        <tbody>
                            ...
                            <?php
                                $nomor = 1;
                            ?>
                            <?php $__currentLoopData = $umkm; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $d): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr id="tr<?php echo e($d->id); ?>">
                                    <td style=" width:5%"><?php echo e($nomor); ?></td>
                                    <td><?php echo e($d->nama); ?></td>
                                    <td><?php echo e($d->nib); ?></td>
                                    <td><?php echo e($d->pemilik); ?></td>
                                    <td><?php echo e($d->alamat_umkm); ?></td>
                                    <td><?php echo e($d->jenis_produk); ?></td>
                                    <td>
                                        <?php if($d->status == 0): ?>
                                            <span
...
<?php echo $__env->make('main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\kurasi\resources\views/dashboard.blade.php ENDPATH**/ ?>